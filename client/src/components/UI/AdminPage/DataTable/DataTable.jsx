	...
	return (
		<div className='table-block'>
			<div className="table-header">
				<Button className='OrangeBtn backBtn' onClick={() => {
							...
							<tr key={row._id} className='t-body'>
								...
								<td>
									<div className="operations">
										...
										<Button className='OrangeBtn backBtn' onClick={() => togglePopup(true, {delete: {id: row._id, message: 'Вы уверены, что хотите удалить запись?'}})}>
