...
const FormGuests = () => {
	const {dates, countGuests, pages, backToRooms, submit, totalPrice, countNights, popupInner, popupContent, showPopup, togglePopup} = useContext(FormContext);
	...
	return (
		<div className={`form-page ${pages[1]}`}>
			...
			{showPopup
				&&
				<Popup toggle={togglePopup} state={showPopup ? 'visible' : 'invisible'}>
					{
